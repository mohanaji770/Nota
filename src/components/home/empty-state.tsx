  ...
  return (
    <section className="grid flex-1 place-items-center px-2 py-12 text-center">
      <div className="max-w-[260px]">
        ...
        <h2 className="mt-5 text-[1.15rem] font-bold leading-7 text-white/86">
          {folderIsAll ? "ابدأ ملاحظتك الأولى" : "لا توجد ملاحظات هنا"}
        </h2>
        <p className="mt-2 text-[0.8rem] font-medium leading-6 text-white/35">
          اكتب ملاحظاتك بسرعة، وثبّت المهم، وكل شيء يبقى محفوظًا بدون اتصال.
        </p>
        <button
          type="button"
          onClick={onCreate}
          className="mt-6 min-h-11 rounded-full bg-white/[0.075] px-5 text-[0.82rem] font-bold text-white/80 ring-1 ring-white/[0.06] transition active:scale-95"
        >
          إنشاء ملاحظة
        </button>
      </div>
